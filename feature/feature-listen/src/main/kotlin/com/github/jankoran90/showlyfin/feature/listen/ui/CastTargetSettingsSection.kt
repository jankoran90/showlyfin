 ...
 * v Nastavení. Zvolený cíl (televize automaticky / Zenbook / jiné zařízení) se uloží a použije
 * u „Na TV"/"Cast" tlačítek u YouTube/podcast video epizod. Parita Nastavení (HARD RULE).
 */
@Composable
fun CastTargetSettingsSection(
    ...
    Column(
        ...
        Text(
            "Kam se pošle video tlačítkem \"Na TV\". Automaticky = televize. Vyber Zenbook (nebo jiné " +
                "zařízení), ať se přehrávání pouští tam.",
