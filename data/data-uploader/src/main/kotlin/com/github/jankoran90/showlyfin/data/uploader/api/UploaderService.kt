...
interface UploaderService {
    ...
    @GET suspend fun sejfItems(@Url url: String, @Header("Cookie") cookie: String): SejfItemsResponse
    ...
    // BUG (2026-09-04) — metadata JEDNOHO videa mimo normální feed okno (rozposlouchaná epizoda
    // mimo limit, viz PodcastSourcesRepository.getYtVideoInfo).
    @GET suspend fun getYtVideoInfo(@Url url: String, @Header("Cookie") cookie: String): YtEpisode
    ...
    @POST suspend fun curatorSimilar(@Url url: String, @Header("Cookie") cookie: String, @Body body: RequestBody): Response<ResponseBody>
