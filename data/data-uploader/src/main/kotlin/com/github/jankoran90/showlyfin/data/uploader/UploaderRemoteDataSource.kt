...
interface UploaderRemoteDataSource {
    suspend fun getStreams(baseUrl: String, sessionCookie: String, mediaType: String, imdbId: String, season: Int? = null, episode: Int? = null, strict: Boolean? = null, link: String? = null, wideLastResort: Boolean? = null): List<UploaderStream>
