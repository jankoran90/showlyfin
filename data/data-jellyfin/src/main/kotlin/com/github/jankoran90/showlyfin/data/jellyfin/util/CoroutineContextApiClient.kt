package com.github.jankoran90.showlyfin.data.jellyfin.util
...
class CoroutineContextApiClient(
    ...
    override val accessToken: String? get() = client.accessToken
    override val clientInfo: ClientInfo get() = client.clientInfo
    override val deviceInfo: DeviceInfo get() = client.deviceInfo
    override val httpClientOptions: HttpClientOptions get() = client.httpClientOptions
    override val webSocket: SocketApi get() = client.webSocket
    ...
    override suspend fun request(
        ...
        requestBody: Any?,
    ): RawResponse = withContext(coroutineContext) {
...
class CoroutineContextApiClientFactory(
    ...
    ): ApiClient = CoroutineContextApiClient(
    ...
    override fun create(clientOptions: HttpClientOptions, scope: CoroutineScope): SocketConnection =
        factory.create(clientOptions, scope)
}
